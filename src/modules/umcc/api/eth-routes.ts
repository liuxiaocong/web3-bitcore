...
EthRoutes.get('/api/UMCC/:network/address/:address/txs/count', async (req, res) => {
...
EthRoutes.post('/api/UMCC/:network/gas', async (req, res) => {
...
EthRoutes.get('/api/UMCC/:network/token/:tokenAddress', async (req, res) => {
...
EthRoutes.get('/api/UMCC/:network/ethmultisig/info/:multisigContractAddress', async (req, res) => {
...
EthRoutes.get('/api/UMCC/:network/ethmultisig/:sender/instantiation/:txId', async (req, res) => {
...
EthRoutes.get('/api/UMCC/:network/ethmultisig/txps/:multisigContractAddress', async (req, res) => {
  const { network, multisigContractAddress } = req.params;
  try {
...
EthRoutes.get('/api/UMCC/:network/ethmultisig/transactions/:multisigContractAddress', async (req, res) => {
